...
trait_name_list <- c("BMI","CAD","HDL","Height","IBD","Intelligence","LDL","RA","Schizophrenia")
```
...
annot_list <- c("brain", "heart", "kidney", "liver", "lung", "muscle", "placenta", "stomach")
trait_name_list <- c("BMI","CAD","HDL","HEIGHT","IBD","INTELLIGENCE","LDL","RA","SCZ","DBP","PP","SBP")
```
...
```{r torus plots}
ggplot_enrichment(result_torus, title = "")
